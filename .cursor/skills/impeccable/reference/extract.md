...
**CRITICAL**: If no design system exists, STOP and call the ask the user directly to clarify. before creating one. Understand the preferred location and structure first.
