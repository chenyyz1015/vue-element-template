...
If a `DESIGN.md` already exists, **do not silently overwrite it**. Show the user the existing file and STOP and call the ask the user directly to clarify. whether to refresh, overwrite, or merge.
