...
This is a required interaction, not optional guidance. Ask these questions in conversation, adapting based on answers. Don't dump them all at once; have a natural dialogue. STOP and call the ask the user directly to clarify.
...
STOP and call the ask the user directly to clarify. Ask for explicit confirmation of the brief before finishing.
